...
module.exports = {
  ...
  CONTRACTS: {
    ...
    AUTHEREUM_PROXY_FACTORY: {
      NAME: 'Authereum Proxy Factory',
      VERSIONS: [
        '2019102500',
        '2019111500',
        '2020070100'
    ...
    AUTHEREUM_ENS_MANAGER: {
      NAME: 'Authereum ENS Manager',
      VERSIONS: [
        '2019102500',
        '2019111500',
        '2020070100'
    ...
    AUTHEREUM_ENS_RESOLVER: {
      NAME: 'Authereum ENS Resolver',
      VERSIONS: [
        '2019102500',
        '2019111500',
        '2020070100'
    ...
    AUTHEREUM_DELEGATE_KEY_MODULE: {
      NAME: 'Authereum Delegate Key Module',
      VERSIONS:[
        '2020070100'
      ]
    },
    AUTHEREUM_RECOVERY_MODULE: {
      NAME: 'Authereum Recovery Module',
      VERSIONS: [
        '2020070100'
      ]
    },
    AUTHEREUM_LOGIN_KEY_VALIDATOR: {
      NAME: 'Authereum Login Key Validator',
      VERSIONS: [
        '2020070100'
      ]
    }
   ...
   */
   ...
   REVERT_MSG: {
    ...
    BA_INSUFFICIENT_GAS_TRANSACTION: 'BA: Insufficient gas for transaction',
    ...
    BMTA_ATOMIC_CALL_OUT_OF_GAS: "BMTA: Atomic call ran out of gas",
    ...
    // Recovery Module
    ARM_INACTIVE_RECOVERY_ACCOUNT: 'ARM: Inactive recovery account',
    ARM_RECOVERY_MODULE_NOT_REGISTERED: 'ARM: Recovery module not registered to account',
    ARM_RECOVERY_ADDRESS_ALREADY_ADDED: 'ARM: Recovery address has already been added',
    ARM_RECOVERY_ADDRESS_CANNOT_BE_ZERO: 'ARM: Recovery address cannot be address(0)',
    ARM_RECOVERY_ADDRESS_CANNOT_BE_SELF: 'ARM: Cannot add self as recovery account',
    ARM_RECOVERY_ADDRESS_ALREADY_INACTIVE: 'ARM: Recovery address is already inactive',
    ARM_RECOVERY_ALREADY_IN_PROCESS: 'ARM: Recovery is already in process',
    ARM_AUTH_KEY_CANNOT_BE_ZERO: 'ARM: Auth Key cannot be address(0)',
    ARM_NO_RECOVERY_ATTEMPT: 'ARM: Recovery attempt does not exist',
    ARM_RECOVERY_DELAY_INCOMPLETE: 'ARM: Recovery attempt delay period has not completed',

    // Delegate Key Module
    ADKM_DELEGATE_KEY_NOT_ACTIVE: 'ADKM: Delegate Key is not active',
    ADKM_MODULE_NOT_REGISTERED: 'ADKM: Delegate Key module not registered to account',
    ADKM_DELEGATE_KEY_CANNOT_BE_ZERO: 'ADKM: Delegate Key cannot be address(0)',
    ADKM_LOCKED_PARAMETERS_LENGTHS_NOT_EQUAL: 'ADKM: lockedParameters must be the same length as lockedParameterValues',
    ADKM_VALUE_HIGHER_THAN_MAXIMUM: 'ADKM: Value is higher than maximum allowed value',
    ADKM_INVALID_FUNCTION_SELECTOR: 'ADKM: Invalid function selector',
  ...
  `0000000957696c6c206661696c00000000000000000000000000000000000000` +
  `00000000`,
